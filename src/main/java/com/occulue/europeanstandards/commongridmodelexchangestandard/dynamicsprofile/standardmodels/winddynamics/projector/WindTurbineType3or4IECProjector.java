...
public class WindTurbineType3or4IECProjector extends WindTurbineType3or4IECEntityProjector {
  ...
  public void handle(UpdateWindTurbineType3or4IECEvent event) {
    ...
    WindTurbineType3or4IEC entity = new WindTurbineType3or4IEC();
    entity.setWindTurbineType3or4IECId(event.getWindTurbineType3or4IECId());
    entity.setWindTurbineType3or4IEC(event.getWindTurbineType3or4IEC());
  ...
  /*
   * @param	event AssignWindTurbineType3or4IECToWindTurbineType3or4IECEvent
   */
  @EventHandler(payloadType = AssignWindTurbineType3or4IECToWindTurbineType3or4IECEvent.class)
  public void handle(AssignWindTurbineType3or4IECToWindTurbineType3or4IECEvent event) {
    LOGGER.info("handling AssignWindTurbineType3or4IECToWindTurbineType3or4IECEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    WindTurbineType3or4IEC entity =
        assignWindTurbineType3or4IEC(event.getWindTurbineType3or4IECId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignWindTurbineType3or4IECFromWindTurbineType3or4IECEvent
   */
  @EventHandler(payloadType = UnAssignWindTurbineType3or4IECFromWindTurbineType3or4IECEvent.class)
  public void handle(UnAssignWindTurbineType3or4IECFromWindTurbineType3or4IECEvent event) {
    LOGGER.info(
        "handling UnAssignWindTurbineType3or4IECFromWindTurbineType3or4IECEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    WindTurbineType3or4IEC entity =
        unAssignWindTurbineType3or4IEC(event.getWindTurbineType3or4IECId());
