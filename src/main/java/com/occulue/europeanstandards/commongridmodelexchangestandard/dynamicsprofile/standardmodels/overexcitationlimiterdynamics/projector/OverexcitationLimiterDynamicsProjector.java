...
public class OverexcitationLimiterDynamicsProjector
  ...
  public void handle(UpdateOverexcitationLimiterDynamicsEvent event) {
    ...
    OverexcitationLimiterDynamics entity = new OverexcitationLimiterDynamics();
    entity.setOverexcitationLimiterDynamicsId(event.getOverexcitationLimiterDynamicsId());
    entity.setOverexcitationLimiterDynamics(event.getOverexcitationLimiterDynamics());
  ...
  /*
   * @param	event AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsEvent
   */
  @EventHandler(
      payloadType = AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsEvent.class)
  public void handle(
      AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsEvent event) {
    LOGGER.info(
        "handling AssignOverexcitationLimiterDynamicsToOverexcitationLimiterDynamicsEvent - "
            + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    OverexcitationLimiterDynamics entity =
        assignOverexcitationLimiterDynamics(
            event.getOverexcitationLimiterDynamicsId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsEvent
   */
  @EventHandler(
      payloadType =
          UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsEvent.class)
  public void handle(
      UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsEvent event) {
    LOGGER.info(
        "handling UnAssignOverexcitationLimiterDynamicsFromOverexcitationLimiterDynamicsEvent - "
            + event);
    ...
    // ------------------------------------------
    OverexcitationLimiterDynamics entity =
        unAssignOverexcitationLimiterDynamics(event.getOverexcitationLimiterDynamicsId());
