...
public class WindTurbineType1or2DynamicsProjector
  ...
  public void handle(UpdateWindTurbineType1or2DynamicsEvent event) {
    ...
    WindTurbineType1or2Dynamics entity = new WindTurbineType1or2Dynamics();
    entity.setWindTurbineType1or2DynamicsId(event.getWindTurbineType1or2DynamicsId());
    entity.setWindTurbineType1or2Dynamics(event.getWindTurbineType1or2Dynamics());
  ...
  /*
   * @param	event AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsEvent
   */
  @EventHandler(
      payloadType = AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsEvent.class)
  public void handle(AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsEvent event) {
    LOGGER.info(
        "handling AssignWindTurbineType1or2DynamicsToWindTurbineType1or2DynamicsEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    WindTurbineType1or2Dynamics entity =
        assignWindTurbineType1or2Dynamics(
            event.getWindTurbineType1or2DynamicsId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsEvent
   */
  @EventHandler(
      payloadType = UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsEvent.class)
  public void handle(
      UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsEvent event) {
    LOGGER.info(
        "handling UnAssignWindTurbineType1or2DynamicsFromWindTurbineType1or2DynamicsEvent - "
            + event);
    ...
    // ------------------------------------------
    WindTurbineType1or2Dynamics entity =
        unAssignWindTurbineType1or2Dynamics(event.getWindTurbineType1or2DynamicsId());
