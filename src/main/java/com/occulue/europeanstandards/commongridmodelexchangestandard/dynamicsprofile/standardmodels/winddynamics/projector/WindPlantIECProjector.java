...
public class WindPlantIECProjector extends WindPlantIECEntityProjector {
  ...
  public void handle(UpdateWindPlantIECEvent event) {
    ...
    WindPlantIEC entity = new WindPlantIEC();
    entity.setWindPlantIECId(event.getWindPlantIECId());
    entity.setWindPlantIEC(event.getWindPlantIEC());
  ...
  /*
   * @param	event AssignWindPlantIECToWindPlantIECEvent
   */
  @EventHandler(payloadType = AssignWindPlantIECToWindPlantIECEvent.class)
  public void handle(AssignWindPlantIECToWindPlantIECEvent event) {
    LOGGER.info("handling AssignWindPlantIECToWindPlantIECEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    WindPlantIEC entity = assignWindPlantIEC(event.getWindPlantIECId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignWindPlantIECFromWindPlantIECEvent
   */
  @EventHandler(payloadType = UnAssignWindPlantIECFromWindPlantIECEvent.class)
  public void handle(UnAssignWindPlantIECFromWindPlantIECEvent event) {
    LOGGER.info("handling UnAssignWindPlantIECFromWindPlantIECEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    WindPlantIEC entity = unAssignWindPlantIEC(event.getWindPlantIECId());
