...
public class UnderexcitationLimiterDynamicsProjector
  ...
  /*
   * @param	event AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsEvent
   */
  @EventHandler(
      payloadType = AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsEvent.class)
  public void handle(
      AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsEvent event) {
    LOGGER.info(
        "handling AssignUnderexcitationLimiterDynamicsToUnderexcitationLimiterDynamicsEvent - "
            + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    UnderexcitationLimiterDynamics entity =
        assignUnderexcitationLimiterDynamics(
            event.getUnderexcitationLimiterDynamicsId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsEvent
   */
  @EventHandler(
      payloadType =
          UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsEvent.class)
  public void handle(
      UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsEvent event) {
    LOGGER.info(
        "handling UnAssignUnderexcitationLimiterDynamicsFromUnderexcitationLimiterDynamicsEvent - "
            + event);
    ...
    // ------------------------------------------
    UnderexcitationLimiterDynamics entity =
        unAssignUnderexcitationLimiterDynamics(event.getUnderexcitationLimiterDynamicsId());
