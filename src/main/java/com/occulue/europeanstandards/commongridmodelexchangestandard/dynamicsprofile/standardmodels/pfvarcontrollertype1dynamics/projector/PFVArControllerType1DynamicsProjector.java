...
public class PFVArControllerType1DynamicsProjector
  ...
  /*
   * @param	event AssignPFVArControllerType1DynamicsToPFVArControllerType1DynamicsEvent
   */
  @EventHandler(
      payloadType = AssignPFVArControllerType1DynamicsToPFVArControllerType1DynamicsEvent.class)
  public void handle(AssignPFVArControllerType1DynamicsToPFVArControllerType1DynamicsEvent event) {
    LOGGER.info(
        "handling AssignPFVArControllerType1DynamicsToPFVArControllerType1DynamicsEvent - "
            + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    PFVArControllerType1Dynamics entity =
        assignPFVArControllerType1Dynamics(
            event.getPFVArControllerType1DynamicsId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignPFVArControllerType1DynamicsFromPFVArControllerType1DynamicsEvent
   */
  @EventHandler(
      payloadType = UnAssignPFVArControllerType1DynamicsFromPFVArControllerType1DynamicsEvent.class)
  public void handle(
      UnAssignPFVArControllerType1DynamicsFromPFVArControllerType1DynamicsEvent event) {
    LOGGER.info(
        "handling UnAssignPFVArControllerType1DynamicsFromPFVArControllerType1DynamicsEvent - "
            + event);
    ...
    // ------------------------------------------
    PFVArControllerType1Dynamics entity =
        unAssignPFVArControllerType1Dynamics(event.getPFVArControllerType1DynamicsId());
