...
public class WindGenTurbineType1IECProjector extends WindGenTurbineType1IECEntityProjector {
  ...
  public void handle(UpdateWindGenTurbineType1IECEvent event) {
    ...
    WindGenTurbineType1IEC entity = new WindGenTurbineType1IEC();
    entity.setWindGenTurbineType1IECId(event.getWindGenTurbineType1IECId());
    entity.setWindGenTurbineType1IEC(event.getWindGenTurbineType1IEC());
  ...
  /*
   * @param	event AssignWindGenTurbineType1IECToWindGenTurbineType1IECEvent
   */
  @EventHandler(payloadType = AssignWindGenTurbineType1IECToWindGenTurbineType1IECEvent.class)
  public void handle(AssignWindGenTurbineType1IECToWindGenTurbineType1IECEvent event) {
    LOGGER.info("handling AssignWindGenTurbineType1IECToWindGenTurbineType1IECEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    WindGenTurbineType1IEC entity =
        assignWindGenTurbineType1IEC(event.getWindGenTurbineType1IECId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignWindGenTurbineType1IECFromWindGenTurbineType1IECEvent
   */
  @EventHandler(payloadType = UnAssignWindGenTurbineType1IECFromWindGenTurbineType1IECEvent.class)
  public void handle(UnAssignWindGenTurbineType1IECFromWindGenTurbineType1IECEvent event) {
    LOGGER.info(
        "handling UnAssignWindGenTurbineType1IECFromWindGenTurbineType1IECEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    WindGenTurbineType1IEC entity =
        unAssignWindGenTurbineType1IEC(event.getWindGenTurbineType1IECId());
