...
public class WindTurbineType3or4DynamicsProjector
  ...
  public void handle(UpdateWindTurbineType3or4DynamicsEvent event) {
    ...
    WindTurbineType3or4Dynamics entity = new WindTurbineType3or4Dynamics();
    entity.setWindTurbineType3or4DynamicsId(event.getWindTurbineType3or4DynamicsId());
    entity.setWindTurbineType3or4Dynamics(event.getWindTurbineType3or4Dynamics());
  ...
  /*
   * @param	event AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsEvent
   */
  @EventHandler(
      payloadType = AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsEvent.class)
  public void handle(AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsEvent event) {
    LOGGER.info(
        "handling AssignWindTurbineType3or4DynamicsToWindTurbineType3or4DynamicsEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    WindTurbineType3or4Dynamics entity =
        assignWindTurbineType3or4Dynamics(
            event.getWindTurbineType3or4DynamicsId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsEvent
   */
  @EventHandler(
      payloadType = UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsEvent.class)
  public void handle(
      UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsEvent event) {
    LOGGER.info(
        "handling UnAssignWindTurbineType3or4DynamicsFromWindTurbineType3or4DynamicsEvent - "
            + event);
    ...
    // ------------------------------------------
    WindTurbineType3or4Dynamics entity =
        unAssignWindTurbineType3or4Dynamics(event.getWindTurbineType3or4DynamicsId());
