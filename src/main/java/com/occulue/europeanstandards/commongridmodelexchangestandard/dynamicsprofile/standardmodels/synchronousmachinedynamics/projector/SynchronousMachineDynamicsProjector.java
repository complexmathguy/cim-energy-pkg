...
public class SynchronousMachineDynamicsProjector extends SynchronousMachineDynamicsEntityProjector {
  ...
  public void handle(UpdateSynchronousMachineDynamicsEvent event) {
    ...
    SynchronousMachineDynamics entity = new SynchronousMachineDynamics();
    entity.setSynchronousMachineDynamicsId(event.getSynchronousMachineDynamicsId());
    entity.setSynchronousMachineDynamics(event.getSynchronousMachineDynamics());
  ...
  /*
   * @param	event AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsEvent
   */
  @EventHandler(
      payloadType = AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsEvent.class)
  public void handle(AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsEvent event) {
    LOGGER.info(
        "handling AssignSynchronousMachineDynamicsToSynchronousMachineDynamicsEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    SynchronousMachineDynamics entity =
        assignSynchronousMachineDynamics(
            event.getSynchronousMachineDynamicsId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsEvent
   */
  @EventHandler(
      payloadType = UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsEvent.class)
  public void handle(UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsEvent event) {
    LOGGER.info(
        "handling UnAssignSynchronousMachineDynamicsFromSynchronousMachineDynamicsEvent - "
            + event);
    ...
    // ------------------------------------------
    SynchronousMachineDynamics entity =
        unAssignSynchronousMachineDynamics(event.getSynchronousMachineDynamicsId());
