...
public class TurbineGovernorDynamicsProjector extends TurbineGovernorDynamicsEntityProjector {
  ...
  public void handle(UpdateTurbineGovernorDynamicsEvent event) {
    ...
    TurbineGovernorDynamics entity = new TurbineGovernorDynamics();
    entity.setTurbineGovernorDynamicsId(event.getTurbineGovernorDynamicsId());
    entity.setTurbineGovernorDynamics(event.getTurbineGovernorDynamics());
  ...
  /*
   * @param	event AssignTurbineGovernorDynamicsToTurbineGovernorDynamicsEvent
   */
  @EventHandler(payloadType = AssignTurbineGovernorDynamicsToTurbineGovernorDynamicsEvent.class)
  public void handle(AssignTurbineGovernorDynamicsToTurbineGovernorDynamicsEvent event) {
    LOGGER.info("handling AssignTurbineGovernorDynamicsToTurbineGovernorDynamicsEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    TurbineGovernorDynamics entity =
        assignTurbineGovernorDynamics(event.getTurbineGovernorDynamicsId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignTurbineGovernorDynamicsFromTurbineGovernorDynamicsEvent
   */
  @EventHandler(payloadType = UnAssignTurbineGovernorDynamicsFromTurbineGovernorDynamicsEvent.class)
  public void handle(UnAssignTurbineGovernorDynamicsFromTurbineGovernorDynamicsEvent event) {
    LOGGER.info(
        "handling UnAssignTurbineGovernorDynamicsFromTurbineGovernorDynamicsEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    TurbineGovernorDynamics entity =
        unAssignTurbineGovernorDynamics(event.getTurbineGovernorDynamicsId());
