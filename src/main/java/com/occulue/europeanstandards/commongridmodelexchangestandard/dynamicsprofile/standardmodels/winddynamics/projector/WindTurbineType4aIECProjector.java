...
public class WindTurbineType4aIECProjector extends WindTurbineType4aIECEntityProjector {
  ...
  public void handle(UpdateWindTurbineType4aIECEvent event) {
    ...
    WindTurbineType4aIEC entity = new WindTurbineType4aIEC();
    entity.setWindTurbineType4aIECId(event.getWindTurbineType4aIECId());
    entity.setWindTurbineType4aIEC(event.getWindTurbineType4aIEC());
  ...
  /*
   * @param	event AssignWindTurbineType4aIECToWindTurbineType4aIECEvent
   */
  @EventHandler(payloadType = AssignWindTurbineType4aIECToWindTurbineType4aIECEvent.class)
  public void handle(AssignWindTurbineType4aIECToWindTurbineType4aIECEvent event) {
    LOGGER.info("handling AssignWindTurbineType4aIECToWindTurbineType4aIECEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    WindTurbineType4aIEC entity =
        assignWindTurbineType4aIEC(event.getWindTurbineType4aIECId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignWindTurbineType4aIECFromWindTurbineType4aIECEvent
   */
  @EventHandler(payloadType = UnAssignWindTurbineType4aIECFromWindTurbineType4aIECEvent.class)
  public void handle(UnAssignWindTurbineType4aIECFromWindTurbineType4aIECEvent event) {
    LOGGER.info("handling UnAssignWindTurbineType4aIECFromWindTurbineType4aIECEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    WindTurbineType4aIEC entity = unAssignWindTurbineType4aIEC(event.getWindTurbineType4aIECId());
