...
public class RemoteInputSignalProjector extends RemoteInputSignalEntityProjector {
  ...
  public void handle(UpdateRemoteInputSignalEvent event) {
    ...
    entity.setRemoteInputSignalId(event.getRemoteInputSignalId());
    entity.setRemoteSignalType(event.getRemoteSignalType());
    entity.setRemoteInputSignal(event.getRemoteInputSignal());
  ...
  /*
   * @param	event AssignRemoteInputSignalToRemoteInputSignalEvent
   */
  @EventHandler(payloadType = AssignRemoteInputSignalToRemoteInputSignalEvent.class)
  public void handle(AssignRemoteInputSignalToRemoteInputSignalEvent event) {
    LOGGER.info("handling AssignRemoteInputSignalToRemoteInputSignalEvent - " + event);

    // ------------------------------------------
    // delegate to addTo
    // ------------------------------------------
    RemoteInputSignal entity =
        addToRemoteInputSignal(event.getRemoteInputSignalId(), event.getAddTo());
  ...
  /*
   * @param	event RemoveRemoteInputSignalFromRemoteInputSignalEvent
   */
  @EventHandler(payloadType = RemoveRemoteInputSignalFromRemoteInputSignalEvent.class)
  public void handle(RemoveRemoteInputSignalFromRemoteInputSignalEvent event) {
    LOGGER.info("handling RemoveRemoteInputSignalFromRemoteInputSignalEvent - " + event);

    RemoteInputSignal entity =
        removeFromRemoteInputSignal(event.getRemoteInputSignalId(), event.getRemoveFrom());
