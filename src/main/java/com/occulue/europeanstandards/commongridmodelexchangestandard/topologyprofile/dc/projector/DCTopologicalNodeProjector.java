...
public class DCTopologicalNodeProjector extends DCTopologicalNodeEntityProjector {
  ...
  public void handle(UpdateDCTopologicalNodeEvent event) {
    ...
    DCTopologicalNode entity = new DCTopologicalNode();
    entity.setDCTopologicalNodeId(event.getDCTopologicalNodeId());
    entity.setDCTopologicalNode(event.getDCTopologicalNode());
  ...
  /*
   * @param	event AssignDCTopologicalNodeToDCTopologicalNodeEvent
   */
  @EventHandler(payloadType = AssignDCTopologicalNodeToDCTopologicalNodeEvent.class)
  public void handle(AssignDCTopologicalNodeToDCTopologicalNodeEvent event) {
    LOGGER.info("handling AssignDCTopologicalNodeToDCTopologicalNodeEvent - " + event);

    // ------------------------------------------
    // delegate to addTo
    // ------------------------------------------
    DCTopologicalNode entity =
        addToDCTopologicalNode(event.getDCTopologicalNodeId(), event.getAddTo());
  ...
  /*
   * @param	event RemoveDCTopologicalNodeFromDCTopologicalNodeEvent
   */
  @EventHandler(payloadType = RemoveDCTopologicalNodeFromDCTopologicalNodeEvent.class)
  public void handle(RemoveDCTopologicalNodeFromDCTopologicalNodeEvent event) {
    LOGGER.info("handling RemoveDCTopologicalNodeFromDCTopologicalNodeEvent - " + event);

    DCTopologicalNode entity =
        removeFromDCTopologicalNode(event.getDCTopologicalNodeId(), event.getRemoveFrom());
