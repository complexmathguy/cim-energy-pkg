...
public class PhaseTapChangerProjector extends PhaseTapChangerEntityProjector {
  ...
  public void handle(UpdatePhaseTapChangerEvent event) {
    ...
    PhaseTapChanger entity = new PhaseTapChanger();
    entity.setPhaseTapChangerId(event.getPhaseTapChangerId());
    entity.setPhaseTapChanger(event.getPhaseTapChanger());
  ...
  /*
   * @param	event AssignPhaseTapChangerToPhaseTapChangerEvent
   */
  @EventHandler(payloadType = AssignPhaseTapChangerToPhaseTapChangerEvent.class)
  public void handle(AssignPhaseTapChangerToPhaseTapChangerEvent event) {
    LOGGER.info("handling AssignPhaseTapChangerToPhaseTapChangerEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    PhaseTapChanger entity =
        assignPhaseTapChanger(event.getPhaseTapChangerId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignPhaseTapChangerFromPhaseTapChangerEvent
   */
  @EventHandler(payloadType = UnAssignPhaseTapChangerFromPhaseTapChangerEvent.class)
  public void handle(UnAssignPhaseTapChangerFromPhaseTapChangerEvent event) {
    LOGGER.info("handling UnAssignPhaseTapChangerFromPhaseTapChangerEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    PhaseTapChanger entity = unAssignPhaseTapChanger(event.getPhaseTapChangerId());
