...
public class NonConformLoadScheduleProjector extends NonConformLoadScheduleEntityProjector {
  ...
  public void handle(UpdateNonConformLoadScheduleEvent event) {
    ...
    NonConformLoadSchedule entity = new NonConformLoadSchedule();
    entity.setNonConformLoadScheduleId(event.getNonConformLoadScheduleId());
    entity.setNonConformLoadSchedules(event.getNonConformLoadSchedules());
  ...
  /*
   * @param	event AssignNonConformLoadSchedulesToNonConformLoadScheduleEvent
   */
  @EventHandler(payloadType = AssignNonConformLoadSchedulesToNonConformLoadScheduleEvent.class)
  public void handle(AssignNonConformLoadSchedulesToNonConformLoadScheduleEvent event) {
    LOGGER.info("handling AssignNonConformLoadSchedulesToNonConformLoadScheduleEvent - " + event);

    // ------------------------------------------
    // delegate to addTo
    // ------------------------------------------
    NonConformLoadSchedule entity =
        addToNonConformLoadSchedules(event.getNonConformLoadScheduleId(), event.getAddTo());
  ...
  /*
   * @param	event RemoveNonConformLoadSchedulesFromNonConformLoadScheduleEvent
   */
  @EventHandler(payloadType = RemoveNonConformLoadSchedulesFromNonConformLoadScheduleEvent.class)
  public void handle(RemoveNonConformLoadSchedulesFromNonConformLoadScheduleEvent event) {
    LOGGER.info("handling RemoveNonConformLoadSchedulesFromNonConformLoadScheduleEvent - " + event);

    NonConformLoadSchedule entity =
        removeFromNonConformLoadSchedules(
            event.getNonConformLoadScheduleId(), event.getRemoveFrom());
