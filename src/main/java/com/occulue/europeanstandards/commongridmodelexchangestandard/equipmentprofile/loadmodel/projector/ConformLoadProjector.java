...
public class ConformLoadProjector extends ConformLoadEntityProjector {
  ...
  /*
   * @param	event AssignEnergyConsumersToConformLoadEvent
   */
  @EventHandler(payloadType = AssignEnergyConsumersToConformLoadEvent.class)
  public void handle(AssignEnergyConsumersToConformLoadEvent event) {
    LOGGER.info("handling AssignEnergyConsumersToConformLoadEvent - " + event);

    // ------------------------------------------
    // delegate to addTo
    // ------------------------------------------
    ConformLoad entity = addToEnergyConsumers(event.getConformLoadId(), event.getAddTo());
  ...
  /*
   * @param	event RemoveEnergyConsumersFromConformLoadEvent
   */
  @EventHandler(payloadType = RemoveEnergyConsumersFromConformLoadEvent.class)
  public void handle(RemoveEnergyConsumersFromConformLoadEvent event) {
    LOGGER.info("handling RemoveEnergyConsumersFromConformLoadEvent - " + event);

    ConformLoad entity = removeFromEnergyConsumers(event.getConformLoadId(), event.getRemoveFrom());
