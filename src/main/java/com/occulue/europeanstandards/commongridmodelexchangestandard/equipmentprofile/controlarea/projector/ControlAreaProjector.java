...
public class ControlAreaProjector extends ControlAreaEntityProjector {
  ...
  public void handle(UpdateControlAreaEvent event) {
    ...
    entity.setControlAreaId(event.getControlAreaId());
    entity.setType(event.getType());
    entity.setControlArea(event.getControlArea());
  ...
  /*
   * @param	event AssignControlAreaToControlAreaEvent
   */
  @EventHandler(payloadType = AssignControlAreaToControlAreaEvent.class)
  public void handle(AssignControlAreaToControlAreaEvent event) {
    LOGGER.info("handling AssignControlAreaToControlAreaEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    ControlArea entity = assignControlArea(event.getControlAreaId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignControlAreaFromControlAreaEvent
   */
  @EventHandler(payloadType = UnAssignControlAreaFromControlAreaEvent.class)
  public void handle(UnAssignControlAreaFromControlAreaEvent event) {
    LOGGER.info("handling UnAssignControlAreaFromControlAreaEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    ControlArea entity = unAssignControlArea(event.getControlAreaId());
