...
public class AnalogLimitSetProjector extends AnalogLimitSetEntityProjector {
  ...
  /*
   * @param	event AssignLimitSetsToAnalogLimitSetEvent
   */
  @EventHandler(payloadType = AssignLimitSetsToAnalogLimitSetEvent.class)
  public void handle(AssignLimitSetsToAnalogLimitSetEvent event) {
    LOGGER.info("handling AssignLimitSetsToAnalogLimitSetEvent - " + event);

    // ------------------------------------------
    // delegate to addTo
    // ------------------------------------------
    AnalogLimitSet entity = addToLimitSets(event.getAnalogLimitSetId(), event.getAddTo());
  ...
  /*
   * @param	event RemoveLimitSetsFromAnalogLimitSetEvent
   */
  @EventHandler(payloadType = RemoveLimitSetsFromAnalogLimitSetEvent.class)
  public void handle(RemoveLimitSetsFromAnalogLimitSetEvent event) {
    LOGGER.info("handling RemoveLimitSetsFromAnalogLimitSetEvent - " + event);

    AnalogLimitSet entity = removeFromLimitSets(event.getAnalogLimitSetId(), event.getRemoveFrom());
