...
public class TapScheduleProjector extends TapScheduleEntityProjector {
  ...
  public void handle(UpdateTapScheduleEvent event) {
    ...
    TapSchedule entity = new TapSchedule();
    entity.setTapScheduleId(event.getTapScheduleId());
    entity.setTapSchedules(event.getTapSchedules());
  ...
  /*
   * @param	event AssignTapSchedulesToTapScheduleEvent
   */
  @EventHandler(payloadType = AssignTapSchedulesToTapScheduleEvent.class)
  public void handle(AssignTapSchedulesToTapScheduleEvent event) {
    LOGGER.info("handling AssignTapSchedulesToTapScheduleEvent - " + event);

    // ------------------------------------------
    // delegate to addTo
    // ------------------------------------------
    TapSchedule entity = addToTapSchedules(event.getTapScheduleId(), event.getAddTo());
  ...
  /*
   * @param	event RemoveTapSchedulesFromTapScheduleEvent
   */
  @EventHandler(payloadType = RemoveTapSchedulesFromTapScheduleEvent.class)
  public void handle(RemoveTapSchedulesFromTapScheduleEvent event) {
    LOGGER.info("handling RemoveTapSchedulesFromTapScheduleEvent - " + event);

    TapSchedule entity = removeFromTapSchedules(event.getTapScheduleId(), event.getRemoveFrom());
