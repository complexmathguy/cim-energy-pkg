...
public class SwitchScheduleProjector extends SwitchScheduleEntityProjector {
  ...
  public void handle(UpdateSwitchScheduleEvent event) {
    ...
    SwitchSchedule entity = new SwitchSchedule();
    entity.setSwitchScheduleId(event.getSwitchScheduleId());
    entity.setSwitchSchedules(event.getSwitchSchedules());
  ...
  /*
   * @param	event AssignSwitchSchedulesToSwitchScheduleEvent
   */
  @EventHandler(payloadType = AssignSwitchSchedulesToSwitchScheduleEvent.class)
  public void handle(AssignSwitchSchedulesToSwitchScheduleEvent event) {
    LOGGER.info("handling AssignSwitchSchedulesToSwitchScheduleEvent - " + event);

    // ------------------------------------------
    // delegate to addTo
    // ------------------------------------------
    SwitchSchedule entity = addToSwitchSchedules(event.getSwitchScheduleId(), event.getAddTo());
  ...
  /*
   * @param	event RemoveSwitchSchedulesFromSwitchScheduleEvent
   */
  @EventHandler(payloadType = RemoveSwitchSchedulesFromSwitchScheduleEvent.class)
  public void handle(RemoveSwitchSchedulesFromSwitchScheduleEvent event) {
    LOGGER.info("handling RemoveSwitchSchedulesFromSwitchScheduleEvent - " + event);

    SwitchSchedule entity =
        removeFromSwitchSchedules(event.getSwitchScheduleId(), event.getRemoveFrom());
