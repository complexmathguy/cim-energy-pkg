...
public class RegulatingControlProjector extends RegulatingControlEntityProjector {
  ...
  public void handle(UpdateRegulatingControlEvent event) {
    ...
    entity.setRegulatingControlId(event.getRegulatingControlId());
    entity.setMode(event.getMode());
    entity.setRegulatingControl(event.getRegulatingControl());
  ...
  /*
   * @param	event AssignRegulatingControlToRegulatingControlEvent
   */
  @EventHandler(payloadType = AssignRegulatingControlToRegulatingControlEvent.class)
  public void handle(AssignRegulatingControlToRegulatingControlEvent event) {
    LOGGER.info("handling AssignRegulatingControlToRegulatingControlEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    RegulatingControl entity =
        assignRegulatingControl(event.getRegulatingControlId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignRegulatingControlFromRegulatingControlEvent
   */
  @EventHandler(payloadType = UnAssignRegulatingControlFromRegulatingControlEvent.class)
  public void handle(UnAssignRegulatingControlFromRegulatingControlEvent event) {
    LOGGER.info("handling UnAssignRegulatingControlFromRegulatingControlEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    RegulatingControl entity = unAssignRegulatingControl(event.getRegulatingControlId());
