...
public class FossilFuelProjector extends FossilFuelEntityProjector {
  ...
  public void handle(UpdateFossilFuelEvent event) {
    ...
    entity.setFossilFuelId(event.getFossilFuelId());
    entity.setFossilFuelType(event.getFossilFuelType());
    entity.setFossilFuels(event.getFossilFuels());
  ...
  /*
   * @param	event AssignFossilFuelsToFossilFuelEvent
   */
  @EventHandler(payloadType = AssignFossilFuelsToFossilFuelEvent.class)
  public void handle(AssignFossilFuelsToFossilFuelEvent event) {
    LOGGER.info("handling AssignFossilFuelsToFossilFuelEvent - " + event);

    // ------------------------------------------
    // delegate to addTo
    // ------------------------------------------
    FossilFuel entity = addToFossilFuels(event.getFossilFuelId(), event.getAddTo());
  ...
  /*
   * @param	event RemoveFossilFuelsFromFossilFuelEvent
   */
  @EventHandler(payloadType = RemoveFossilFuelsFromFossilFuelEvent.class)
  public void handle(RemoveFossilFuelsFromFossilFuelEvent event) {
    LOGGER.info("handling RemoveFossilFuelsFromFossilFuelEvent - " + event);

    FossilFuel entity = removeFromFossilFuels(event.getFossilFuelId(), event.getRemoveFrom());
