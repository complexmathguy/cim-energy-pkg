...
public class DCBaseTerminalProjector extends DCBaseTerminalEntityProjector {
  ...
  /*
   * @param	event AssignDCTerminalsToDCBaseTerminalEvent
   */
  @EventHandler(payloadType = AssignDCTerminalsToDCBaseTerminalEvent.class)
  public void handle(AssignDCTerminalsToDCBaseTerminalEvent event) {
    LOGGER.info("handling AssignDCTerminalsToDCBaseTerminalEvent - " + event);

    // ------------------------------------------
    // delegate to addTo
    // ------------------------------------------
    DCBaseTerminal entity = addToDCTerminals(event.getDCBaseTerminalId(), event.getAddTo());
  ...
  /*
   * @param	event RemoveDCTerminalsFromDCBaseTerminalEvent
   */
  @EventHandler(payloadType = RemoveDCTerminalsFromDCBaseTerminalEvent.class)
  public void handle(RemoveDCTerminalsFromDCBaseTerminalEvent event) {
    LOGGER.info("handling RemoveDCTerminalsFromDCBaseTerminalEvent - " + event);

    DCBaseTerminal entity =
        removeFromDCTerminals(event.getDCBaseTerminalId(), event.getRemoveFrom());
