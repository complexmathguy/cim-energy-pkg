...
public class AccumulatorResetProjector extends AccumulatorResetEntityProjector {
  ...
  public void handle(UpdateAccumulatorResetEvent event) {
    ...
    AccumulatorReset entity = new AccumulatorReset();
    entity.setAccumulatorResetId(event.getAccumulatorResetId());
    entity.setAccumulatorReset(event.getAccumulatorReset());
  ...
  /*
   * @param	event AssignAccumulatorResetToAccumulatorResetEvent
   */
  @EventHandler(payloadType = AssignAccumulatorResetToAccumulatorResetEvent.class)
  public void handle(AssignAccumulatorResetToAccumulatorResetEvent event) {
    LOGGER.info("handling AssignAccumulatorResetToAccumulatorResetEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    AccumulatorReset entity =
        assignAccumulatorReset(event.getAccumulatorResetId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignAccumulatorResetFromAccumulatorResetEvent
   */
  @EventHandler(payloadType = UnAssignAccumulatorResetFromAccumulatorResetEvent.class)
  public void handle(UnAssignAccumulatorResetFromAccumulatorResetEvent event) {
    LOGGER.info("handling UnAssignAccumulatorResetFromAccumulatorResetEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    AccumulatorReset entity = unAssignAccumulatorReset(event.getAccumulatorResetId());
