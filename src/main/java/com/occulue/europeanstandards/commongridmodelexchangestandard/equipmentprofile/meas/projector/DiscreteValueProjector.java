...
public class DiscreteValueProjector extends DiscreteValueEntityProjector {
  ...
  public void handle(UpdateDiscreteValueEvent event) {
    ...
    entity.setDiscreteValues(event.getDiscreteValues());
  ...
  /*
   * @param	event AssignDiscreteValuesToDiscreteValueEvent
   */
  @EventHandler(payloadType = AssignDiscreteValuesToDiscreteValueEvent.class)
  public void handle(AssignDiscreteValuesToDiscreteValueEvent event) {
    LOGGER.info("handling AssignDiscreteValuesToDiscreteValueEvent - " + event);

    // ------------------------------------------
    // delegate to addTo
    // ------------------------------------------
    DiscreteValue entity = addToDiscreteValues(event.getDiscreteValueId(), event.getAddTo());
  ...
  /*
   * @param	event RemoveDiscreteValuesFromDiscreteValueEvent
   */
  @EventHandler(payloadType = RemoveDiscreteValuesFromDiscreteValueEvent.class)
  public void handle(RemoveDiscreteValuesFromDiscreteValueEvent event) {
    LOGGER.info("handling RemoveDiscreteValuesFromDiscreteValueEvent - " + event);

    DiscreteValue entity =
        removeFromDiscreteValues(event.getDiscreteValueId(), event.getRemoveFrom());
