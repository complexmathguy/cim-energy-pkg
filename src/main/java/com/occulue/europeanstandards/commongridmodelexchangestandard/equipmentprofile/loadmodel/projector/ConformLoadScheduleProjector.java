...
public class ConformLoadScheduleProjector extends ConformLoadScheduleEntityProjector {
  ...
  public void handle(UpdateConformLoadScheduleEvent event) {
    ...
    ConformLoadSchedule entity = new ConformLoadSchedule();
    entity.setConformLoadScheduleId(event.getConformLoadScheduleId());
    entity.setConformLoadSchedules(event.getConformLoadSchedules());
  ...
  /*
   * @param	event AssignConformLoadSchedulesToConformLoadScheduleEvent
   */
  @EventHandler(payloadType = AssignConformLoadSchedulesToConformLoadScheduleEvent.class)
  public void handle(AssignConformLoadSchedulesToConformLoadScheduleEvent event) {
    LOGGER.info("handling AssignConformLoadSchedulesToConformLoadScheduleEvent - " + event);

    // ------------------------------------------
    // delegate to addTo
    // ------------------------------------------
    ConformLoadSchedule entity =
        addToConformLoadSchedules(event.getConformLoadScheduleId(), event.getAddTo());
  ...
  /*
   * @param	event RemoveConformLoadSchedulesFromConformLoadScheduleEvent
   */
  @EventHandler(payloadType = RemoveConformLoadSchedulesFromConformLoadScheduleEvent.class)
  public void handle(RemoveConformLoadSchedulesFromConformLoadScheduleEvent event) {
    LOGGER.info("handling RemoveConformLoadSchedulesFromConformLoadScheduleEvent - " + event);

    ConformLoadSchedule entity =
        removeFromConformLoadSchedules(event.getConformLoadScheduleId(), event.getRemoveFrom());
