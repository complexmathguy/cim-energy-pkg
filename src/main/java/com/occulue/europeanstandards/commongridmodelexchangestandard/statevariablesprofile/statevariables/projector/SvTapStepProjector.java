...
public class SvTapStepProjector extends SvTapStepEntityProjector {
  ...
  public void handle(UpdateSvTapStepEvent event) {
    ...
    entity.setSvTapStep(event.getSvTapStep());
  ...
  /*
   * @param	event AssignSvTapStepToSvTapStepEvent
   */
  @EventHandler(payloadType = AssignSvTapStepToSvTapStepEvent.class)
  public void handle(AssignSvTapStepToSvTapStepEvent event) {
    LOGGER.info("handling AssignSvTapStepToSvTapStepEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    SvTapStep entity = assignSvTapStep(event.getSvTapStepId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignSvTapStepFromSvTapStepEvent
   */
  @EventHandler(payloadType = UnAssignSvTapStepFromSvTapStepEvent.class)
  public void handle(UnAssignSvTapStepFromSvTapStepEvent event) {
    LOGGER.info("handling UnAssignSvTapStepFromSvTapStepEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    SvTapStep entity = unAssignSvTapStep(event.getSvTapStepId());
