...
public class LocationProjector extends LocationEntityProjector {
  ...
  /*
   * @param	event AssignLocationToLocationEvent
   */
  @EventHandler(payloadType = AssignLocationToLocationEvent.class)
  public void handle(AssignLocationToLocationEvent event) {
    LOGGER.info("handling AssignLocationToLocationEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    Location entity = assignLocation(event.getLocationId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignLocationFromLocationEvent
   */
  @EventHandler(payloadType = UnAssignLocationFromLocationEvent.class)
  public void handle(UnAssignLocationFromLocationEvent event) {
    LOGGER.info("handling UnAssignLocationFromLocationEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    Location entity = unAssignLocation(event.getLocationId());
