...
public class SubGeographicalRegionProjector extends SubGeographicalRegionEntityProjector {
  ...
  public void handle(UpdateSubGeographicalRegionEvent event) {
    ...
    SubGeographicalRegion entity = new SubGeographicalRegion();
    entity.setSubGeographicalRegionId(event.getSubGeographicalRegionId());
    entity.setRegions(event.getRegions());
  ...
  /*
   * @param	event AssignRegionsToSubGeographicalRegionEvent
   */
  @EventHandler(payloadType = AssignRegionsToSubGeographicalRegionEvent.class)
  public void handle(AssignRegionsToSubGeographicalRegionEvent event) {
    LOGGER.info("handling AssignRegionsToSubGeographicalRegionEvent - " + event);

    // ------------------------------------------
    // delegate to addTo
    // ------------------------------------------
    SubGeographicalRegion entity =
        addToRegions(event.getSubGeographicalRegionId(), event.getAddTo());
  ...
  /*
   * @param	event RemoveRegionsFromSubGeographicalRegionEvent
   */
  @EventHandler(payloadType = RemoveRegionsFromSubGeographicalRegionEvent.class)
  public void handle(RemoveRegionsFromSubGeographicalRegionEvent event) {
    LOGGER.info("handling RemoveRegionsFromSubGeographicalRegionEvent - " + event);

    SubGeographicalRegion entity =
        removeFromRegions(event.getSubGeographicalRegionId(), event.getRemoveFrom());
