...
public class TerminalProjector extends TerminalEntityProjector {
  ...
  /*
   * @param	event AssignTerminalsToTerminalEvent
   */
  @EventHandler(payloadType = AssignTerminalsToTerminalEvent.class)
  public void handle(AssignTerminalsToTerminalEvent event) {
    LOGGER.info("handling AssignTerminalsToTerminalEvent - " + event);

    // ------------------------------------------
    // delegate to addTo
    // ------------------------------------------
    Terminal entity = addToTerminals(event.getTerminalId(), event.getAddTo());
  ...
  /*
   * @param	event RemoveTerminalsFromTerminalEvent
   */
  @EventHandler(payloadType = RemoveTerminalsFromTerminalEvent.class)
  public void handle(RemoveTerminalsFromTerminalEvent event) {
    LOGGER.info("handling RemoveTerminalsFromTerminalEvent - " + event);

    Terminal entity = removeFromTerminals(event.getTerminalId(), event.getRemoveFrom());
